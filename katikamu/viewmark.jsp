...
<h1 style="border-radius: 50px; padding: 5px;font-family: Georgia, serif;font-size: 15px;font-weight: bold;color: #2F4F4F;"align="left"> KATIKAMU <img src="photo1.jpg" alt="Image" height="50" width="150"> PRIMARY SCHOOL<br>Student's Marks</h1>
